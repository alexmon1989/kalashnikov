...
@include('admin.layout.breadcrumbs', [
            'title' => 'Редактирование поставщика продуктов',
            'items' => array(
                    ...
                    array('title' => 'Редактирование поставщика продуктов', 'action' => '', 'active' => TRUE),
            )
        ])
@stop
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Редактирование поставщика продуктов "{{ $provider->title }}"</h3>
