<form role="form" method="post" enctype="multipart/form-data">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <p class="help-block">Не обязательно заполнять. Есть смысл заполнять в базовых категориях, в дочерних изображение не будет видно. Форматы: <b>jpg, png, gif</b>. Размер: <b>487px * 308px</b>. Программа приведёт изображение к этому разрешению автоматически без сохранения пропорций сторон.</p>
        </div>
        <div class="form-group">
