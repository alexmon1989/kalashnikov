...
<div class="row">
    <div class="col-md-8">
        ...
        <p>Присылайте нам своё резюме с помощью формы справа, а если у вас нету готового резюме, вы можете заполнить нашу специальную форму, перейдя по этой <a href="#">ссылке</a>.</p>
    </div>
