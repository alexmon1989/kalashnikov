            ...
            <div class="col-md-3">
                <div class="thumbnails thumbnail-style thumbnail-kenburn">
                    <div class="thumbnail-img">
                        ...
                        <a class="btn-more hover-effect" href="{{ action('Marketing\ProductsController@getCategory', ['id' => $categories[$i+$j]->id]) }}">Смотреть +</a>
                    </div>
                    <div class="caption">
                        <h3><a class="hover-effect" href="{{ action('Marketing\ProductsController@getCategory', ['id' => $categories[$i+$j]->id]) }}">{{ $categories[$i+$j]->title }}</a></h3>
